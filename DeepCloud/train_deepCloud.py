...
from datasets import deepcloud_train_gf1,deepcloud_trainval_gf1,deepcloud_test_gf1
...
def get_argparser():
    ...
    parser.add_argument("--data_root", type=str, default='./GF1_datasets/data/',
                        help="path to Dataset")
    parser.add_argument("--proposal_mask", type=str,default='./GF1_datasets/data/pseudoMask/erodeMFC/',
                        help="path to Dataset")
    ...
    parser.add_argument("--gpu_id", type=str, default='3,5',
                        help="GPU ID")
    ...
    parser.add_argument("--loss_type", type=str, default='crossEntropy',
                        choices=['cross_entropy', 'focal_loss','partialCELoss','partialBoundaryLoss'],
...
def get_dataset(opts):
    ...
    if opts.dataset == 'gf1':
        ...
        train_dst = deepcloud_train_gf1(root=opts.data_root, mask_dir=opts.proposal_mask, image_set='train')
        val_dst = deepcloud_trainval_gf1(root=opts.data_root, image_set='test')
...
def main():
    ...
    # Set up criterion
    if opts.loss_type == 'crossEntropy':
